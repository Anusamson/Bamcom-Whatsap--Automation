...
class UpdateContactRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $contactId = $contact instanceof Contact ? $contact->id : (is_numeric($contact) ? (int) $contact : null);
    ...
    {
        return [
            'phone.unique' => 'This phone number is already assigned to another CRM contact.',

...
class UpdateKnowledgeRecordRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'category' => ['sometimes', 'required', Rule::enum(KnowledgeCategory::class)],
            'content' => ['sometimes', 'required', 'string'],
            'status' => ['sometimes', 'required', Rule::enum(KnowledgeStatus::class)],

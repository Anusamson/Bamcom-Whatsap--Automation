...
export default function Edit({ sequence, pipelineStages = [], users = [] }) {
    const initialSteps = sequence.steps?.length > 0
        ? sequence.steps.map((s) => ({
            ...
            assignment_config: s.assignment_config || null,
            notification_config: s.notification_config || null,
            applicability_rules: s.applicability_rules || null,
        }))
        : [];
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        exit_on_deal_won: Boolean(sequence.exit_on_deal_won),
        exit_on_reply: Boolean(sequence.exit_on_reply),
        steps: initialSteps
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('sequences.update', sequence.id));
    };
            ...
            <div className="py-6 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        <Link
                            href={route('sequences.show', sequence.id)}
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                                Update cadence steps and execution guardrails
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-end gap-3 pt-4">
                        ...
                        >
                            {processing ? 'Saving...' : 'Update Sequence'}
                        </button>
                    </div>
                </form>
            </div>
